...
fn create_camera(width: u32, height: u32) -> Camera {
    ...
    panic!(
        "Step 2a) Initialize and return a new Camera by calling its 'new' function with the \
...
fn main() {
    ...
    let camera = panic!(
        "Step 2a) Initialize a camera by calling the 'create_camera()' \
